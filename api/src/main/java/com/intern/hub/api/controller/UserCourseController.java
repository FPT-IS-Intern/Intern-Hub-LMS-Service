...
public class UserCourseController {
  ...
  @Operation(
      ...
      description =
          "Lấy danh sách khóa học có phân trang, kèm trạng thái enroll của user hiện tại.")
  ...
  @Operation(
      ...
      description =
          "Lấy chi tiết khóa học theo id, kèm trạng thái enroll và tiến độ của user hiện tại.")
  public ResponseApi<CourseUserDetailResponse> getCourse(
  ...
  public ResponseApi<PaginatedData<LessonUserSummaryResponse>> getCourseLessons(
      @PathVariable("courseId") String courseId, @PageableDefault Pageable pageable) {
    Long courseIdValue = parseId(courseId, "courseId");
