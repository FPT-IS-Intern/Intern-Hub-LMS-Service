...
public interface SubmissionAttachmentEntityRepository
  ...
  @Modifying
  @Query(
      "DELETE FROM SubmissionAttachmentEntity sa WHERE sa.lessonSubmissionEntity.lessonEnrollmentEntity.courseEnrollmentEntity.courseEntity.courseId = :courseId")
