...
public class CourseEvaluatorRepositoryImpl implements CourseEvaluatorRepository {
  ...
  @Override
  public Page<EvaluatorCourseOverviewModel> findAllCourseOverviews(
      Long evaluatorUserId, Pageable pageable) {
    return toOverviewModels(
        courseEvaluatorEntityRepository.findAllCourseOverviews(evaluatorUserId, pageable));
  }
  ...
  public Page<EvaluatorCourseOverviewModel> findCourseOverviewsByEvaluatorUserId(
      Long evaluatorUserId, Pageable pageable) {
    return toOverviewModels(
        courseEvaluatorEntityRepository.findCourseOverviewsByEvaluatorUserId(
