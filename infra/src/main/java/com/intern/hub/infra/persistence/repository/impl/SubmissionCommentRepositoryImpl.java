...
public class SubmissionCommentRepositoryImpl implements SubmissionCommentRepository {
  ...
  @Override
  public java.util.List<SubmissionCommentModel> findByLessonSubmissionIdOrderByCommentAtDesc(
      Long lessonSubmissionId) {
    return submissionCommentEntityRepository
        .findByLessonSubmissionEntity_LessonSubmissionIdOrderByCommentAtDesc(lessonSubmissionId)
        .stream()
        .map(this::toModel)
        .toList();
  }
