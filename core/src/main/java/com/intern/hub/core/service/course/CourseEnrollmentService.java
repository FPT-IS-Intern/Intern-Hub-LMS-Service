...
public class CourseEnrollmentService {
    ...
    public void enrollCourse(Long courseId, Long userId) {
        courseRepository
                .findById(courseId)
                .orElseThrow(() -> new NotFoundException("course.not.found", "Không tìm thấy khóa học id: " + courseId));

        CourseEnrollmentModel courseEnrollment = courseEnrollmentRepository
                .findByCourseIdAndUserId(courseId, userId)
                .orElseGet(() -> courseEnrollmentRepository.save(
