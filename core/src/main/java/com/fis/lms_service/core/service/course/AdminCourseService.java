...
/**
 * Nhóm nghiệp vụ quản trị khóa học (admin):
 * tạo/cập nhật/xóa khóa học, lấy danh sách/chi tiết và quản lý ảnh đại diện khóa học.
 */
@Service
...
public class AdminCourseService {
  ...
  /**
   * Tạo mới khóa học.
   * Ảnh đại diện là bắt buộc; danh sách bài học (nếu có) sẽ được liên kết theo thứ tự đã truyền.
   */
  @Transactional
  ...
  /**
   * Xóa khóa học và các quan hệ liên quan.
   * Ảnh đại diện cũ sẽ được xóa khỏi storage sau khi transaction commit thành công.
   */
  @Transactional
