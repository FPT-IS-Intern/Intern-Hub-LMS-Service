...
/**
 * Nhóm nghiệp vụ quản trị bài học (admin):
 * tạo/cập nhật/xóa bài học, lấy danh sách/chi tiết và quản lý ảnh + file bài học.
 */
@Service
...
public class AdminLessonService {
  ...
  /**
   * Tạo mới bài học.
   * Có thể upload ảnh đại diện, file tài liệu (material) và file bài tập (assignment).
   */
  @Transactional
   ...
   * Hỗ trợ thay ảnh, thêm file mới và xóa các file hiện có theo danh sách id.
   */
  @Transactional
  ...
  /**
   * Xóa bài học và toàn bộ file liên quan.
   * Các object trên storage sẽ được xóa sau khi transaction commit.
   */
  @Transactional
