...
public class LessonFileService {
    ...
    public void uploadFiles(Long lessonId, List<MultipartFile> files) {
        ...
        long currentTotalSize = lessonFileRepository
                .getTotalSizeByLessonId(lessonId);

        long uploadSize = files
                .stream()
        ...
        for (MultipartFile file : files) {
            ...
            LessonFileModel model = LessonFileModel.builder()
                    .lessonId(lessonId)
                    .fileUrl(s3Key)
    ...
    public List<LessonFileModel> getFiles(Long lessonId) {
        return lessonFileRepository.findAllByLessonId(lessonId)
                .stream()
    ...
    public void deleteFile(Long lessonFileId) {
        ...
        LessonFileModel lessonFileModel = lessonFileRepository
                .findByLessonFileId(lessonFileId);
